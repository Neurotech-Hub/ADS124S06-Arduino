...
#define CRC_INITIAL_SEED 0
#define IS_SENDSTAT_SET (bool)0 // ((bool) (getRegisterValue(REG_ADDR_SYS) & ADS_SENDSTATUS_MASK))
#define IS_CRC_SET (bool)0      // ((bool) (getRegisterValue(REG_ADDR_SYS) & ADS_CRC_MASK))
